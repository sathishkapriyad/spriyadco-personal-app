    ...
    <div className="my-skills2">
      <div className="container">
        <div className="sec-head text-center mb-80">
          <h6 className="sub-title main-color mb-15">My Superpowers</h6>
          <h2>
          Transforming ideas into <span className="fw-200">high-impact</span> digital experiences. 
          </h2>
        </div>
        <div className="row md-marg">
          ...
          <div className="col-lg-2 col-md-4 col-6">
            <div className="item mb-30">
              ...
              <h6 className="fz-18">Machine Learning & AI </h6>
            </div>
          </div>
        </div>
      </div>
