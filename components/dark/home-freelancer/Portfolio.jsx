...
function Portfolio() {
  ...
  return (
    <section
      ...
      data-scroll-index="3" id="works"
    >
      <div className="container">
        <div className="sec-head mb-80">
          <h6 className="sub-title main-color mb-25">My Works</h6>
          <div className="bord pt-25 bord-thin-top d-flex align-items-center">
            <h2>
              My featured <span className="fw-200">projects</span>
            </h2>
        ...
        <div className="work-swiper-center">
          ...
          >
            {data.map((item, i) => (
              <SwiperSlide key={i}>
                <div className="item">
                  <div className="img h-auto sm:h-64 md:h-80 lg:h-96 xl:h-auto">
