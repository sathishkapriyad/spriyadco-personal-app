...
function Navbar() {
  ...
  function toggleMenu() {
    ...
    setTimeout(() => {
      if (hamenu.classList.contains('open')) {
        hamenu.style.left = '0';
      } else {
  ...
  function toggleNavbar() {
    ...
    document.querySelector('#navbarSupportedContent2').classList.toggle('show');
  }
    ...
    <>
      <style jsx>{`
        @media (max-width: 991px) {
          ...
          #navbarSupportedContent, #navbarSupportedContent2 {
            order: 1;
          }
          .navbar-toggler {
            position: absolute;
      ...
      <nav className="navbar navbar-expand-lg bord blur">
        <div className="container">
          <button
            ...
            aria-controls="navbarSupportedContent navbarSupportedContent2"
            aria-expanded="false"
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav">
              <li className="nav-item">
                <a className="nav-link" href="#home" onClick={(e) => handleSectionScroll(e, 'home')} data-scroll-nav="0">
                  <span className="rolling-text">Home</span>
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="#services" onClick={(e) => handleSectionScroll(e, 'services')} data-scroll-nav="1">
                  <span className="rolling-text">Services</span>
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="#about" onClick={(e) => handleSectionScroll(e, 'about')} data-scroll-nav="2">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent2">
            <ul className="navbar-nav">
              <li className="nav-item">
                <a className="nav-link" href="#works" onClick={(e) => handleSectionScroll(e, 'works')} data-scroll-nav="3">
                  <span className="rolling-text">Portfolio</span>
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="#blog" onClick={(e) => handleSectionScroll(e, 'blog')} data-scroll-nav="5">
                  <span className="rolling-text">Blog</span>
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="#contact" onClick={(e) => handleSectionScroll(e, 'contact')} data-scroll-nav="6">
